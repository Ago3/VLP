...
CUDA_VISIBLE_DEVICES=0 python3 main.py \
    ...
    --file_valid_jpgs /media/SHARED/HDD1_2TB/acalabrese/vlp_data/COCO/annotations/coco_valid_jpgs.json --split test --output_dir /media/SHARED/HDD1_2TB/acalabrese/vlp_data/output/cc --sensemb
...
do
	CUDA_VISIBLE_DEVICES=0 python3 main.py \
	    ...
	    --region_det_file_prefix feat_cls_1000/silver/ \
	    --region_bbox_file feat_cls_1000/silver/batch_0_second_half_bboxes.pkl \
	    --file_valid_jpgs /media/SHARED/HDD1_2TB/acalabrese/vlp_data/COCO/annotations/coco_valid_jpgs.json --split test --output_dir /media/SHARED/HDD1_2TB/acalabrese/vlp_data/output/silver/0_${half}h/cc --sensemb
done
...
do
	CUDA_VISIBLE_DEVICES=0 python3 main.py \
	    ...
	    --region_det_file_prefix feat_cls_1000/silver/ \
	    --region_bbox_file feat_cls_1000/silver/batch_${batch}_bboxes.pkl \
	    --file_valid_jpgs /media/SHARED/HDD1_2TB/acalabrese/vlp_data/COCO/annotations/coco_valid_jpgs.json --split test --output_dir /media/SHARED/HDD1_2TB/acalabrese/vlp_data/output/silver/${batch}/cc --sensemb
done